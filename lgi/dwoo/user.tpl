		...
		<form action='user.php' method='POST'>
			...
			<fieldset class="collapsible uncollapsed"><legend>Password</legend>
				<ol class="cmxform">
					...
					<li><label for='pwd2'>New password:</label> <input type='password' name='pwd2' id='pwd2' /></li>
				</ol>
...
*}
			...
			<fieldset class="collapsible uncollapsed"><legend>LGI credentials</legend>
				<div>It is possible to contact LGI from your computer directly, without
				having to login to this portal. Download your credentials using the
				button below, and save it into your {*
				*}{if $ua_windows}personal profile directory ("Documents and Settings"){else}home directory{/if}.
				...
				this to connect to and authenticate with the LGI project server.
				<em>Important:</em> this file contains your private key. Please do not
