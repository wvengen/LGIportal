{*****************************************************************************************
 *	The template for listing all resources. It extends the homs_base.tpl. 
...
{block "content"}
			<h2>
				...
				<form action="listresources.php" method="post" class="cmxform">				
				<fieldset>
				<ol>					
        			 	<li>					
        			 	...
        			 	<li>
        			 		<input type="submit" value="Show all Resources" />
